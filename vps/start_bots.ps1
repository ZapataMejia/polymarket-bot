...
#   V4A  - Endgame 30pp  (edge >= 30pp en los ultimos 5 min)  <- el rey
...
#   - V5: solo 216 trades/año, $98/mes — slot desperdiciado
...
Write-Host "Bots V1, V2B, V4A y V4B lanzados en ventanas minimizadas." -ForegroundColor Green
Write-Host "Logs: logs\paper_v1.log, paper_v2b.log, paper_v4.log, paper_v4b.log" -ForegroundColor Gray
