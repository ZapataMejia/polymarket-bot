...
Write-Host "Bots V1, V2B, V4A, V4B y V4C lanzados en ventanas minimizadas." -ForegroundColor Green
Write-Host "Logs: logs\paper_v1.log, paper_v2b.log, paper_v4.log, paper_v4b.log, paper_v4c.log" -ForegroundColor Gray
